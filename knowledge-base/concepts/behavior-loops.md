...
tags:
  ...
  - habit-formation
  - learning
source_chapter: "Chapter 6 - Behavior Loops: How the Body Learns (and Why It Gets Stuck)"
source_pages: [69-82]
...
images:
  - path: images/habit-loop-cue-routine-reward.jpg
    alt: "The habit loop showing cue, routine, and reward cycle"
    caption: "The habit loop: cue triggers routine, routine produces reward, reward reinforces loop"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 71
  - path: images/habit-loop-simple-diagram.jpg
    alt: "Simple habit loop diagram with cue, routine, and reward"
    caption: "Basic behavior loop structure"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 73
  - path: images/habit-formation-neural-networks.jpg
    alt: "Neural networks involved in habit formation showing limbic, associative, and sensorimotor networks"
    caption: "Habit formation shifts from goal-directed (associative) to automatic (sensorimotor) networks"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 70
  - path: images/corticospinal-tract-pathway.jpg
    alt: "Corticospinal tract from pre-central gyrus through brainstem to spinal cord and muscles"
    caption: "Motor command pathway: cortex to muscle via corticospinal tract"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 75
  - path: images/amygdala-prefrontal-cortex-safety.jpg
    alt: "Brain regions for safety assessment showing amygdala, hippocampus, and prefrontal cortex"
    caption: "Safety gate: amygdala and prefrontal cortex evaluate threat before allowing loop changes"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 80
  - path: images/seven-movement-patterns.jpg
    alt: "Seven fundamental movement patterns: squat, hip hinge, lunge, push, pull, twist, gait"
    caption: "Seven movement patterns the body learns and automates"
    source_chapter: "Chapter 6 - Behavior Loops"
    source_page: 82
...
![Habit Loop - Cue, Routine, Reward](../images/habit-loop-cue-routine-reward.jpg)
...
![Habit Formation Neural Networks](../images/habit-formation-neural-networks.jpg)
...
![Corticospinal Tract Pathway](../images/corticospinal-tract-pathway.jpg)
...
![Amygdala and Prefrontal Cortex - Safety Assessment](../images/amygdala-prefrontal-cortex-safety.jpg)
...
![Seven Movement Patterns](../images/seven-movement-patterns.jpg)
